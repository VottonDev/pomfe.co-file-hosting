...
function moon() {
  ...
  a.innerHTML = "<ruby>おはよう! <rp>(</rp><rt>Ohay&#x14D;!</rt><rp>)</rp></ruby>", a.lang = "jp"
}
var Zepto = function() {
  function a(a) {
...
window.Zepto = Zepto, "$" in window || (window.$ = Zepto),
  ...
  function() {
    ...
    d.prototype = Object.create(EventEmitter.prototype), d.prototype.upload = function(a) {
      ...
      f.open(b.method, this.url, !0), f.upload.addEventListener("loadstart", function(a) {
  ...
  function(a) {
    ...
    var e = function(a) {
      ...
      f = function(a, b, c) {
        ...
        return d.addClass(c || ""), $("<div class=progress-inner>").appendTo(f), d.attr("data-filename", escape(a)), e.text(a), g.text(b), d.append(e, f, g, h), d
      };
    b.on("change", function(b) {
      ...
      d.forEach(function(a) {
        if (-1 !== a.name.indexOf(".exe", a.name.length - ".exe".length)) {
          ...
          return b.appendTo(c), c.addClass("error"), void $(".file-name", b).text("Uploading .exe files is blocked due to abuse.")
        }
        f(a.name, a.humanSize).appendTo(c)
      });
      var g = f("", d.humanSize, "total");
      if (g.appendTo(c), d.size > e) return c.addClass("error"), void $(".file-name", g).text("onii-chan y-your upload is t-too big&hellip;");
        ...
        switch (a.target.status) {
          case 200:
            ...
            i(b.files, function(a, b, c) {
              var e = $("<a>");
              e.attr("href", "https://a.pomfe.co/" + b.url).attr("target", "_BLANK").text("a.pomfe.co/" + b.url), $(".file-url", a).append(e);
            ...
            break;
          case 413:
            c.addClass("error completed"), j.html($("<div/>").html("onii-chan, y-your upload is t-too big&hellip;").text());
            break;
          default:
  ...
  function(a, b) {
    ...
    var c, d, e, f = a,
      ...
      $ = function(a) {
        if ("object" == typeof a && null !== a)
          ...
          if ("containerId" === b || "swfObjectId" === b) {
            if (!na(a[b])) throw new Error("The specified `" + b + "` value is not valid as an HTML4 Element ID");
            Z[b] = a[b]
          } else Z[b] = a[b]; {
      ...
      ba = function(a, d) {
        ...
        if ("string" == typeof a && a) g = a.toLowerCase().split(/\s+/);
          ...
          for (e in a) w.call(a, e) && "string" == typeof e && e && "function" == typeof a[e] && Va.on(e, a[e]);
        if (g && g.length) {
      ...
      ca = function(a, b) {
        ...
        if (0 === arguments.length) f = u(P);
          ...
          for (c in a) w.call(a, c) && "string" == typeof c && c && "function" == typeof a[c] && Va.off(c, a[c]);
        if (f && f.length)
      ...
      fa = function() {
        var a = N.sandboxed;
        if (Ta(), "boolean" != typeof N.ready && (N.ready = !1), N.sandboxed !== a && N.sandboxed === !0) N.ready = !1, Va.emit({
          type: "error",
      ...
      ha = function(a, b) {
        var c;
        if ("object" == typeof a && a && "undefined" == typeof b) c = a, Va.clearData();
        else {
      ...
      ta = function(a) {
        if ("object" == typeof a && a && a.type) {
          ...
          if (e && e.length) {
            ...
            for (g = 0, h = e.length; h > g; g++) i = e[g], j = l, "string" == typeof i && "function" == typeof f[i] && (i = f[i]), "object" == typeof i && i && "function" == typeof i.handleEvent && (j = i, i = i.handleEvent), "function" == typeof i && (k = A({}, a), sa(i, j, [k], b))
          }
          return this
        }
      },
    ...
    var _a = function(a) {
      ...
      eb = function(a) {
        if (!Xa[this.id]) throw new Error("Attempted to clip element(s) to a destroyed ZeroClipboard client instance");
        a = kb(a);
        for (var b = 0; b < a.length; b++)
          if (w.call(a, b) && a[b] && 1 === a[b].nodeType) {
            ...
            var c = Xa[this.id] && Xa[this.id].elements; - 1 === c.indexOf(a[b]) && c.push(a[b])
          }
        return this
      },
      fb = function(a) {
      ...
      jb = function(a) {
        ...
        if ("object" == typeof a && a && a.type && b) {
          ...
          if (g && g.length) {
            ...
            for (h = 0, i = g.length; i > h; h++) j = g[h], k = m, "string" == typeof j && "function" == typeof f[j] && (j = f[j]), "object" == typeof j && j && "function" == typeof j.handleEvent && (k = j, j = j.handleEvent), "function" == typeof j && (l = A({}, a), sa(j, k, [l], c))
          }
        }
      },
      kb = function(a) {
    ...
    Va._createClient = function() {
      ...
      if (!Xa[this.id]) throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
      ...
      if (!Xa[this.id]) throw new Error("Attempted to clear pending clipboard data from a destroyed ZeroClipboard client instance");
      return Va.clearData.apply(this, z(arguments)), this
    }, Va.prototype.getData = function() {
      if (!Xa[this.id]) throw new Error("Attempted to get pending clipboard data from a destroyed ZeroClipboard client instance");
...
>>> > 0679270 b8efe0aeee1582874be64442dfe71d51c
