document.addEventListener("DOMContentLoaded", function () {
    ...
    function c(a) {
        var b = a.target,
            ...
            d = b.row,
            e = b.percent;
        e.style.visibility = "hidden", c.style.visibility = "hidden", d.removeChild(c), d.removeChild(e);
        var f = b.status,
        ...
        if (200 === f) {
            ...
            i.success ? (h.textContent = i.files[0].url.replace(/.*?:\/\//g, ""), h.href = i.files[0].url, g.appendChild(h)) : c.innerHTML = "Error: " + i.description
    ...
    function d(a, d) {
        ...
        g.open("POST", "/upload.php"), g.row = d, g.bar = e, g.percent = f, g.upload.bar = e, g.upload.percent = f, g.addEventListener("load", c, !1), g.upload.onprogress = b;
        var h = new FormData;
