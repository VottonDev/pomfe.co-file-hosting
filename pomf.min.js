function moon() {
  var a = document.getElementById("ohayou");
  a.innerHTML = "<ruby>おはよう! <rp>(</rp><rt>Ohay&#x14D;!</rt><rp>)</rp></ruby>",
  a.lang = "jp"
}
var Zepto = function() {
  function a(a) {
  ...
  function l(a) {
    return a in H
      ? H[a]
      : H[a] = new RegExp("(^|\\s)" + a + "(\\s|$)")
  }
  function m(a, b) {
    return "number" != typeof b || J[k(a)]
      ? b
      : b + "px"
  }
  function n(a) {
  ...
  function p(a, b, c) {
    for (x in b)
      c && (f(b[x]) || g(b[x]))
        ? (f(b[x]) && !f(a[x]) && (a[x] = {}), g(b[x]) && !g(a[x]) && (a[x] = []), p(a[x], b[x], c))
        : b[x] !== w && (a[x] = b[x])
    }
  function q(a, b) {
    return null == b
    ...
    val: function(a) {
      return a === w
        ? this[0] && (this[0].multiple
          ? y(this[0]).find("option").filter(function(a) {
...
function() {
  ...
  EventEmitter.prototype.emit = function(a) {
    if (this.hasOwnProperty("_events") && a in this._events != !1)
      for (var b = 0, c = this._events[a].length; c > b; b++)
  ...
  Object.defineProperty(FileList.prototype, "humanSize", a),
  Object.defineProperty(File.prototype, "humanSize", a);
  var b = {
    get: function() {
      return this.uploadedSize / this.size
    }
  };
  Object.defineProperty(FileList.prototype, "percentUploaded", b),
  Object.defineProperty(File.prototype, "percentUploaded", b),
  ...
  d.prototype = Object.create(EventEmitter.prototype),
    ...
    f.upload.addEventListener("progress", function(a) {
      if (a.lengthComputable) {
        ...
        for (var b = 0, e = c.length; e > b; b++)
          c[b].uploadedSize = Math.min(size, c[b].size),
          size -= c[b].uploadedSize,
          size <= 0 && (c.current = c[b], size = 0)
      }
...
function(a) {
  ...
  a.fn.cabinet = function(b) {
    ...
    b[0].filelist = Object.create(FileList),
    b.on("change", function(a) {
      this.filelist = a.target.files,
      c.change()
    }),
    d("dragenter", "dragenter", !0),
    d("dragover", "dragover", !0),
    d("dragleave", "dragleave", !0),
    d("click", "click", !1),
    d("drop", "dragleave", !0, function(a) {
      b[0].filelist = a.dataTransfer.files,
      c.change()
    })
  }
}($),
$(function() {
  var a = $("#upload-input"),
    ...
    c = $("#upload-filelist"),
    d = "";
  $.hasFileAPI() || ($("#no-file-api").show(), b.hide()),
  b.cabinet(a),
  b.on("dragenter", function(a) {
    this === a.target && ($(this).addClass("drop"), d = $(this).html(), $(this).html("Drop it here~"))
  }),
  ...
  var e = function(a) {
      var b = a.attr("data-max-size") || "100MiB",
        ...
        d = /(?:([KMGTPEZY])(i)?B|([BKMGTPEZY]))/.exec(b) || [
          "B", "", ""
        ],
        e = Math.pow("i" === d[2]
          ? 1024
          : 1e3, "BKMGTPEZY".indexOf(d[1]));
      return c * e
    }(a),
    f = function(a, b, c) {
      var d = $("<li class=file>"),
      ...
      return d.addClass(c || ""),
      $("<div class=progress-inner>").appendTo(f),
      d.attr("data-filename", escape(a)),
      e.text(a),
      g.text(b),
      d.append(e, f, g, h),
      d
  ...
  b.on("change", function(b) {
    ...
    d.forEach(function(a) {
      if (-1 !== a.name.indexOf(".exe", a.name.length - ".exe".length)) {
        var b = f("", d.humanSize, "total");
        return b.appendTo(c),
        c.addClass("error"),
        void $(".file-name", b).text("Uploading .exe files is blocked due to abuse.")
      }
      f(a.name, a.humanSize).appendTo(c)
    });
    var g = f("", d.humanSize, "total");
    if (g.appendTo(c), d.size > e)
      return c.addClass("error"),
      void $(".file-name", g).text("onii-chan it's too big");
    var h = d.upload("upload.php"),
      i = function(a, b) {
        var c = {};
        a.forEach(function(d) {
          ++c[d.name] || (c[d.name] = 0);
          var e = $($('li[data-filename="' + escape(d.name) + '"]')[c[d.name] || 0]);
          b.call(e, e, d, a)
        })
      },
      j = $(".file-name", g);
    ...
    h.on("load", function(a, b) {
      ...
      switch (a.target.status) {
        case 200:
          ...
          if (!b.success) {
            c.addClass("error"),
            $(".file-name", g).text("Something went wrong; try again later.");
            break
          }
          i(b.files, function(a, b, c) {
            var e = $("<a>");
            e.attr("href", "https://a.pomfe.co/" + b.url).attr("target", "_BLANK").text("a.pomfe.co/" + b.url),
            $(".file-url", a).append(e);
            var f = "<button id='copycat" + d + "' class='copycat ion-link' data-clipboard-text='https://a.pomfe.co/" + b.url + "'></button>";
            $(".file-url", a).append(f);
            var g = new ZeroClipboard(document.getElementById("copycat" + d));
            g.on("ready", function(a) {
              g.on("aftercopy", function(a) {})
            }),
            d++
          }),
          ...
          break;
        case 413:
          c.addClass("error completed"),
          j.html($("<div/>").html("onii-chan, y-your upload is t-too big&hellip;").text());
          break;
        default:
          c.addClass("error completed"),
          j.text("Something went wrong; try again later.")
      }
    }),
    h.upload()
  })
...
function(a, b) {
  ...
  var c,
    ...
    H = function(a) {
      var b,
        c;
      return "string" == typeof a && a && (c = a.match(/^(?:|[^:@]*@|.+\)@(?=https[s]?|file)|.+?\s+(?: at |@)(?:[^:\(]+ )*[\(]?)((?:http[s]?|file):\/\/[\/]?.+?\/[^:\)]*?)(?::\d+)(?::\d+)?/), c && c[1]
        ? b = c[1]
        : (c = a.match(/\)@((?:https[s]?|file):\/\/[\/]?.+?\/[^:\)]*?)(?::\d+)(?::\d+)?/), c && c[1] && (b = c[1]))),
      b
    },
    I = function() {
      var a,
      ...
      if ("readyState" in c[0])
        for (d = c.length; d--;)
          if ("interactive" === c[d].readyState && (a = c[d].src))
            return a;
    return "loading" === g.readyState && (a = c[c.length - 1].src)
        ? a
        : (a = I())
          ? a
          : b
    ...
    if (g && g.length) {
        for (e = 0, f = g.length; f > e; e++)
          ...
          P[a] || (P[a] = []),
          P[a].push(d);
        if (h.ready && N.ready && Va.emit({type: "ready"}), h.error) {
          for (e = 0, f = W.length; f > e; e++)
            if (N[W[e].replace(/^flash-/, "")] === !0) {
              Va.emit({type: "error", name: W[e]});
              break
            }
          c !== b && Va.version !== c && Va.emit({type: "error", name: "version-mismatch", jsVersion: Va.version, swfVersion: c})
        }
      }
      return Va
    },
    ...
    ea = function(a) {
      ...
      return a = oa(a),
      a && !va(a)
        ? "ready" === a.type && N.overdue === !0
          ? Va.emit({type: "error", name: "flash-overdue"})
          : (b = A({}, a), ta.call(this, b), "copy" === a.type && (d = Da(Q), c = d.data, R = d.formatMap), c)
        : void 0
    },
    fa = function() {
      var a = N.sandboxed;
      if (Ta(), "boolean" != typeof N.ready && (N.ready = !1), N.sandboxed !== a && N.sandboxed === !0)
        N.ready = !1,
        Va.emit({type: "error", name: "flash-sandboxed"});
        ...
        "number" == typeof b && b >= 0 && (S = i(function() {
          ...
          N.deactivated === !0 && Va.emit({type: "error", name: "flash-deactivated"})
        }, b)),
        N.overdue = !1,
        Ba()
      }
    ...
    ia = function(a) {
      "undefined" == typeof a
        ? (E(Q), R = null)
        : "string" == typeof a && w.call(Q, a) && delete Q[a]
    },
    ja = function(a) {
      return "undefined" == typeof a
        ? B(Q)
        : "string" == typeof a && w.call(Q, a)
          ? Q[a]
          : void 0
    },
    ka = function(a) {
      if (a && 1 === a.nodeType) {
        d && (La(d, Z.activeClass), d !== a && La(d, Z.hoverClass)),
        d = a,
        Ka(a, Z.hoverClass);
    ...
    la = function() {
      ...
      d && (La(d, Z.hoverClass), La(d, Z.activeClass), d = null)
    },
    ma = function() {
      return d || null
    },
    ...
    oa = function(a) {
      ...
      if ("string" == typeof a && a
        ? (b = a, a = {})
        : "object" == typeof a && a && "string" == typeof a.type && a.type && (b = a.type), b) {
        b = b.toLowerCase(),
        ...
        "error" === a.type && (X.test(a.name) && A(a, {
          target: null,
          minimumVersion: O
        }), Y.test(a.name) && A(a, {version: N.version})),
        "copy" === a.type && (a.clipboardData = {
          setData: Va.setData,
          clearData: Va.clearData
        }),
        "aftercopy" === a.type && (a = Ea(a, R)),
        a.target && !a.relatedTarget && (a.relatedTarget = pa(a.target)),
        qa(a)
      }
    },
    pa = function(a) {
    ...
    qa = function(a) {
      if (a && /^_(?:click|mouse(?:over|out|down|up|move))$/.test(a.type)) {
        var c = a.target,
          d = "_mouseover" === a.type && a.relatedTarget
            ? a.relatedTarget
            : b,
          e = "_mouseout" === a.type && a.relatedTarget
            ? a.relatedTarget
            : b,
          h = Na(c),
          ...
          m = h.left + ("number" == typeof a._stageX
            ? a._stageX
            : 0),
          n = h.top + ("number" == typeof a._stageY
            ? a._stageY
            : 0),
          o = m - k,
          p = n - l,
          q = i + o,
          r = j + p,
          s = "number" == typeof a.movementX
            ? a.movementX
            : 0,
          t = "number" == typeof a.movementY
            ? a.movementY
            : 0;
        delete a._stageX,
        delete a._stageY,
      ...
      if ("object" == typeof a && a && a.type) {
        ...
        if (e && e.length) {
          ...
          for (g = 0, h = e.length; h > g; g++)
            ...
            "function" == typeof i && (k = A({}, a), sa(i, j, [k], b))
        }
        return this
      }
    },
      ...
      switch (delete a._source, a.type) {
        ...
        case "copy":
          var i,
            j,
            k = a.relatedTarget;
          !Q["text/html"] && !Q["text/plain"] && k && (j = k.value || k.outerHTML || k.innerHTML) && (i = k.value || k.textContent || k.innerText)
            ? (a.clipboardData.clearData(), a.clipboardData.setData("text/plain", i), j !== i && a.clipboardData.setData("text/html", j))
            : !Q["text/plain"] && a.target && (i = a.target.getAttribute("data-clipboard-text")) && (a.clipboardData.clearData(), a.clipboardData.setData("text/plain", i));
          break;
        case "aftercopy":
          wa(a),
          Va.clearData(),
          b && b !== Ja() && b.focus && b.focus();
          break;
        case "_mouseover":
          Va.focus(b),
          Z.bubbleEvents === !0 && f && (b && b !== a.relatedTarget && !F(a.relatedTarget, b) && xa(A({}, a, {
            type: "mouseenter",
            bubbles: !1,
            cancelable: !1
          })), xa(A({}, a, {type: "mouseover"})));
          break;
        case "_mouseout":
          Va.blur(),
          Z.bubbleEvents === !0 && f && (b && b !== a.relatedTarget && !F(a.relatedTarget, b) && xa(A({}, a, {
            ...
            bubbles: !1,
            cancelable: !1
          })), xa(A({}, a, {type: "mouseout"})));
          break;
        case "_mousedown":
          Ka(b, Z.activeClass),
          Z.bubbleEvents === !0 && f && xa(A({}, a, {type: a.type.slice(1)}));
          break;
        case "_mouseup":
          La(b, Z.activeClass),
          Z.bubbleEvents === !0 && f && xa(A({}, a, {type: a.type.slice(1)}));
    ...
    ya = function() {
      ...
      if ("number" == typeof a && a >= 0) {
        ...
        T = k(function() {
          ...
          Oa(a) && (Pa(), N.deactivated = null, Va.emit({type: "error", name: "swf-not-found"}))
        }, b)
      }
    },
    za = function() {
    ...
    Ba = function() {
      ...
      if (!b) {
        ...
        k.innerHTML = '<object id="' + Z.swfObjectId + '" name="' + Z.swfObjectId + '" width="100%" height="100%" ' + (l
          ? 'classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"'
          : 'type="application/x-shockwave-flash" data="' + i + '"') + ">" + (l
          ? '<param name="movie" value="' + i + '"/>'
          : "") + '<param name="allowScriptAccess" value="' + d + '"/><param name="allowNetworking" value="' + e + '"/><param name="menu" value="false"/><param name="wmode" value="transparent"/><param name="flashvars" value="' + h + '"/><div id="' + Z.swfObjectId + '_fallbackContent">&nbsp;</div></object>',
        b = k.firstChild,
        k = null,
        y(b).ZeroClipboard = Va,
        c.replaceChild(b, j),
        ya()
      }
    ...
    Ca = function() {
      ...
      if (a) {
        var d = Aa(a);
        d && ("activex" === N.pluginType && "readyState" in a
          ? (a.style.display = "none", function e() {
            if (4 === a.readyState) {
              for (var b in a)
    ...
    Ga = function(a) {
      var b,
        ...
        g = "",
        h = [];
      if (a.trustedDomains && ("string" == typeof a.trustedDomains
        ? e = [a.trustedDomains]
        : "object" == typeof a.trustedDomains && "length" in a.trustedDomains && (e = a.trustedDomains)), e && e.length)
      ...
      a.forceEnhancedClipboard === !0 && (g += (g
        ? "&"
        : "") + "forceEnhancedClipboard=true"),
      "string" == typeof a.swfObjectId && a.swfObjectId && (g += (g
        ? "&"
        : "") + "swfObjectId=" + n(a.swfObjectId)),
      "string" == typeof a.jsVersion && a.jsVersion && (g += (g
        ? "&"
        : "") + "jsVersion=" + n(a.jsVersion)),
      g
    },
    Ha = function(a) {
      if (null == a || "" === a)
    ...
    Ra = function(a) {
      N.ready === !0 && (N.bridge && "function" == typeof N.bridge.setHandCursor
        ? N.bridge.setHandCursor(a)
        : N.ready = !1)
    },
    Sa = function(a) {
  ...
  var Va = function() {
    return this instanceof Va
      ? void("function" == typeof Va._createClient && Va._createClient.apply(this, z(arguments)))
      : new Va
  };
  v(Va, "version", {
    value: "2.2.0",
  ...
  var _a = function(a) {
    ...
    if (g && g.length) {
        ...
        if (h.ready && N.ready && this.emit({type: "ready", client: this}), h.error) {
          ...
          c !== b && Va.version !== c && this.emit({type: "error", name: "version-mismatch", jsVersion: Va.version, swfVersion: c})
        }
      }
      return this
    },
    ...
    cb = function(a) {
      var b = null,
        c = Xa[this.id] && Xa[this.id].handlers;
      return c && (b = "string" == typeof a && a
        ? c[a]
          ? c[a].slice(0)
          : []
        : B(c)),
    ...
    eb = function(a) {
      ...
      for (var b = 0; b < a.length; b++)
        if (w.call(a, b) && a[b] && 1 === a[b].nodeType) {
          a[b].zcClippingId
            ? -1 === Za[a[b].zcClippingId].indexOf(this.id) && Za[a[b].zcClippingId].push(this.id)
            : (a[b].zcClippingId = "zcClippingId_" + Ya++, Za[a[b].zcClippingId] = [this.id], Z.autoActivate === !0 && lb(a[b]));
      ...
      if ("object" == typeof a && a && a.type && b) {
        ...
        if (g && g.length) {
          ...
          for (h = 0, i = g.length; i > h; h++)
            ...
            "function" == typeof j && (l = A({}, a), sa(j, k, [l], c))
        }
      }
    },
    kb = function(a) {
  ...
  Va.prototype.setText = function(a) {
    ...
    return Va.setData("text/plain", a),
    this
  },
  Va.prototype.setHtml = function(a) {
    if (!Xa[this.id])
      throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
    return Va.setData("text/html", a),
    this
  },
  Va.prototype.setRichText = function(a) {
    if (!Xa[this.id])
      throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
    return Va.setData("application/rtf", a),
    this
  },
  Va.prototype.setData = function() {
    if (!Xa[this.id])
      throw new Error("Attempted to set pending clipboard data from a destroyed ZeroClipboard client instance");
    return Va.setData.apply(this, z(arguments)),
    this
  },
  Va.prototype.clearData = function() {
    if (!Xa[this.id])
      throw new Error("Attempted to clear pending clipboard data from a destroyed ZeroClipboard client instance");
    return Va.clearData.apply(this, z(arguments)),
    this
  },
